...
\end{equation}
While there are extra terms in this functional compared to the expression in Cartesian coordinates, all of them are expressible in the Unified Form Language or related domain-specfici languages for PDEs.
...
We could treat the Christoffel symbols as distributions but this would be complicated and require linearity.
We have instead opted for an approach that avoids explicit introduction of metrics, Christoffel symbols, or Riemannian geometry.
It's possible to approach the problem this way because we are given an explicit isometry into Euclidean space.
...
\textcolor{red}{Make a flowchart of the whole test suite.}
